...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "👤 Beneficiary Portal (Pending):"
    echo "   Email:    test.beneficiary@gmail.com"
    echo "   Password: User@2026"
    echo ""
    echo "👤 Beneficiary Portal (Selected - Employment Track):"
    echo "   Email:    john.mugisha@gmail.com"
    echo "   Password: User@2026"
    echo ""
    echo "👤 Beneficiary Portal (Selected - Entrepreneurship Track):"
    echo "   Email:    alice.uwimana@gmail.com"
    echo "   Password: User@2026"
    echo ""
    echo "🌐 Access the portal at: http://localhost:5173/"
    echo ""
    echo "📖 For more details, see TEST_CREDENTIALS.md"
    echo "=========================================="
else
    echo ""
